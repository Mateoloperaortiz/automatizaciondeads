...
class JobService(BaseService[JobOpening], IJobService):
    """
    ...
    @classmethod
    def get_active_jobs(cls) -> List[JobOpening]:
        """
        ...
        """
        return JobOpening.query.filter_by(status="active").all()

    @classmethod
    def get_jobs_by_status(cls, status: str) -> List[JobOpening]:
        """
        ...
        """
        return JobOpening.query.filter_by(status=status).all()
