            ...
            "schemas": {
                "Job": {
                    ...
                    "properties": {
                        ...
                        "title": {"type": "string", "description": "Título de la oferta de empleo"},
                        "description": {
                            "type": "string",
                        ...
                        "salary": {"type": "number", "description": "Salario ofrecido"},
                        "created_at": {
                            "type": "string",
                            "format": "date-time",
                ...
                "Candidate": {
                    "type": "object",
                    "properties": {
                        "candidate_id": {"type": "string", "description": "ID único del candidato"},
                        "name": {"type": "string", "description": "Nombre del candidato"},
                        "email": {"type": "string", "description": "Email del candidato"},
                        "phone": {"type": "string", "description": "Teléfono del candidato"},
                        "resume": {"type": "string", "description": "Resumen del candidato"},
                        "created_at": {
                            "type": "string",
                            "format": "date-time",
                ...
                "Application": {
                    ...
                    "properties": {
                        ...
                        "candidate_id": {"type": "string", "description": "ID del candidato"},
                        "job_opening_id": {
                            "type": "string",
                            "description": "ID de la oferta de empleo",
                        },
                        "status": {"type": "string", "description": "Estado de la aplicación"},
                        "created_at": {
                            "type": "string",
                            "format": "date-time",
