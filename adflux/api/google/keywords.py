...
class KeywordManager:
    ...
    def get_keywords(self, customer_id: str, ad_group_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            for row in response:
                ...
                keyword_data = {
                    ...
                    "quality_score": (
                        ...
                        if hasattr(quality_info, "quality_score")
                        else None
                    ),
                }
            ...
            logger.info(
                f"Se recuperaron {len(keywords)} palabras clave para el cliente {customer_id}."
            )
            return {
                "success": True,
            ...
            logger.error(
                f"Error inesperado al obtener palabras clave para el cliente {customer_id}: {e}", e
            )
            return {"success": False, "message": f"Error inesperado: {str(e)}", "keywords": []}
    ...
    def create_keyword(
        ...
        try:
            ...
            criterion_id = ad_group_criterion_service.parse_ad_group_criterion_path(
                ad_group_criterion_resource_name
            )["criterion_id"]

            logger.info(
                f"Se creó correctamente la palabra clave '{keyword_text}' con ID: {criterion_id}"
            )
            ...
            return {"success": False, "message": f"Error inesperado: {str(e)}", "keyword_id": None}

    @handle_google_ads_api_error
    def create_keywords_batch(
        self, customer_id: str, ad_group_id: str, keywords: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": False, "message": f"Error inesperado: {str(e)}", "keyword_ids": []}
