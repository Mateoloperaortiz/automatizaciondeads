...
class AdManager:
    ...
    def get_ads(self, customer_id: str, ad_group_id: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            for row in response:
                ...
                if ad_type == 'TEXT_AD' and hasattr(ad, 'text_ad'):
                    ...
                    ad_details = {
                        ...
                        'description1': text_ad.description1 if hasattr(text_ad, 'description1') else None,
                        'description2': text_ad.description2 if hasattr(text_ad, 'description2') else None
                    }
                elif ad_type == 'EXPANDED_TEXT_AD' and hasattr(ad, 'expanded_text_ad'):
                    expanded_text_ad = ad.expanded_text_ad
                    ad_details = {
                        'headline_part1': expanded_text_ad.headline_part1 if hasattr(expanded_text_ad, 'headline_part1') else None,
                        'headline_part2': expanded_text_ad.headline_part2 if hasattr(expanded_text_ad, 'headline_part2') else None,
                        'headline_part3': expanded_text_ad.headline_part3 if hasattr(expanded_text_ad, 'headline_part3') else None,
                        'description': expanded_text_ad.description if hasattr(expanded_text_ad, 'description') else None,
                        'description2': expanded_text_ad.description2 if hasattr(expanded_text_ad, 'description2') else None
                    }
            ...
            return {
                'success': True,
                'message': f"Se recuperaron {len(ads)} anuncios.",
                'ads': ads
            }
            ...
            logger.error(f"Error inesperado al obtener anuncios para el cliente {customer_id}: {e}", e)
            return {
                'success': False,
