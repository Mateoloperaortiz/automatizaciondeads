...
class MetaUtils:
    ...
    def upload_image(self, ad_account_id: str, image_path: str) -> Tuple[bool, str, Dict[str, Any]]:
        ...
        try:
            ...
            return (
                ...
                {"hash": image_hash, "id": image.get("id"), "url": image.get("url")},
            )
    ...
    def create_custom_audience(
        ...
        try:
            ...
            logger.info(
                f"Audiencia personalizada '{name}' creada correctamente con ID: {audience_id}"
            )

            return (
                True,
                f"Audiencia personalizada '{name}' creada correctamente",
                {"id": audience_id, "name": name, "description": description},
            )
