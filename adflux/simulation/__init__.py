...
from .job_data import generate_job_opening, generate_multiple_jobs

# Importar funciones de generación de candidatos
from .candidate_data import generate_candidate_profile, generate_multiple_candidates
...
from .utils import setup_gemini_client, generate_with_gemini
