...
class JobOpening(db.Model):
    ...
    company_name = db.Column(String(100), nullable=True, name='company')  # Nombre de columna 'company' para compatibilidad
    ...
    education_level = db.Column(String(50), nullable=True)  # High School, Bachelor's, Master's, etc.
